...
SAS – obróbka danych i analiza statystyczna.
LaTeX – przygotowanie raportu końcowego.

# Struktura plików
* `raport_analizy_spolek.pdf` – raport.
* `analiza-spolek.sas` – skrypt z obliczeniami.
* `dane/` – surowe dane giełdowe (Stooq).
